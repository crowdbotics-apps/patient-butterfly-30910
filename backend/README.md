...
## Project Structure
    ...
    ├── patient_butterfly_30910  # Django project configurations
...
1. Clone this repo and `cd patient_butterfly_30910`
...
2. Clone this repo and `cd patient_butterfly_30910`
